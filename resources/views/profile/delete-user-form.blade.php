<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingUserDeletion">
            ...
            <x-slot name="content">
                {{ __('Você tem certeza de que deseja excluir sua conta? Uma vez que sua conta é excluída, todos os seus recursos e dados serão excluídos permanentemente. Insira sua senha para confirmar que deseja excluir permanentemente sua conta.') }}
