<div>
                                ...
                                <div class="flex items-center">
                                    @if ($token->last_used_at)
                                        <div class="text-sm text-gray-400">
                                            {{ __('Ultima utilização') }} {{ $token->last_used_at->diffForHumans() }}
                                        </div>
                                    @endif
    ...
    <x-jet-dialog-modal wire:model="displayingToken">
        ...
        <x-slot name="content">
            <div>
                {{ __('Copie o seu novo token de API. Para sua segurança, ele não será mostrado novamente.') }}
            </div>
    ...
    <x-jet-confirmation-modal wire:model="confirmingApiTokenDeletion">
        ...
        <x-slot name="content">
            {{ __('Você tem certeza de que gostaria de excluir esse token de API?') }}
        </x-slot>
