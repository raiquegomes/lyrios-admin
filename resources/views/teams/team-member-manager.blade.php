...
<div>
                ...
                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Por favor, forneça o endereço de e-mail da pessoa que você gostaria de adicionar a esta equipe.') }}
                        </div>
                    </div>

                    <!-- Member Email -->
                    <div class="col-span-6 sm:col-span-4">
                        <x-jet-label for="email" value="{{ __('Email do membro') }}" />
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            <x-jet-label for="role" value="{{ __('Função') }}" />
    ...
    <x-jet-confirmation-modal wire:model="confirmingTeamMemberRemoval">
        ...
        <x-slot name="content">
            {{ __('Tem certeza que gostaria de remover essa pessoa da equipe?') }}
        </x-slot>
