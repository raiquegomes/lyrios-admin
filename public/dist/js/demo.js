...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('AdminLTE:Demo:MessageShowed')) < Date.now()) {
      ...
      alert('O projeto está em desenvolvimento para testes!')
    }
  }, 1000)
  ...
  $container.append(
    '<h5>Customização do Liryos Painel</h5><hr class="mb-2"/>'
  )
  ...
  $container.append('<h6>Header Opções</h6>')
  ...
  $container.append('<h6>Sidebar Opções</h6>')
  ...
  $container.append('<h6>Footer Opções</h6>')
  ...
  $container.append('<h6>Small Text Opções</h6>')
